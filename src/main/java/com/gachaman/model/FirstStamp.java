...
public enum FirstStamp
{
	...
	FIRST_SIDE_BET("Side Hustle", "Side bets pay bonus GC on top of task rewards."),
	...
	FIRST_DUPE("Deja Vu", "Duplicate cards auto-convert to GC."),
	...
	FIRST_CYCLE("Fate Survived", "Every 5 tasks fate re-rolls your combat style."),
